      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-10 md:flex-row md:items-start">
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-3xl font-bold text-emerald-600 tracking-[-0.05em] uppercase">
              Herfa
            </span>
          </div>
...
function SocialIcon({ Icon }) {
  return (
    <div className="group flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-gray-100 bg-white text-slate-400 shadow-sm transition-all duration-500 hover:bg-emerald-500 hover:text-white">
